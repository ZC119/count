...
add_arg('batch_size',       int,   3,        "Minibatch size.")
add_arg('num_passes',       int,   120,       "Epoch number.")
add_arg('use_gpu',          bool,  True,      "Whether use GPU.")
add_arg('parallel',         bool,  False,      "Parallel.")
add_arg('dataset',          str,   'count', "count.")
add_arg('model_save_dir',   str,   'model',     "The path to save model.")
add_arg('pretrained_model', str,   'pretrained/mobilenet_v1_imagenet/', "The init model path.")
...
add_arg('data_dir',         str,   'data/count', "data directory")
